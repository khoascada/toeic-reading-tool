...
import { Part7PassageCard } from './part-7-passage-card';
import { Part7PassageAnalysis } from './part-7-passage-analysis';
import { Part7QuestionCard } from './part-7-question-card';
import type { ReadingPassageItem, Part7StatusFilter } from '../types';

interface Part7PracticeViewProps {
  passage: ReadingPassageItem;
  phase: 'PRACTICE' | 'SUBMITTED';
  currentStatus?: Part7StatusFilter;
...
const STATUS_LABELS: Record<Part7StatusFilter, string> = {
  ALL: 'Tất cả bài',
  UNANSWERED: 'Bài chưa làm',
  ANSWERED: 'Bài đã làm',
};

export const Part7PracticeView: React.FC<Part7PracticeViewProps> = ({
  passage,
  phase,
  currentStatus = 'ALL',
  selectedAnswers,
    ...
    <div className="container mx-auto max-w-7xl px-3 sm:px-6 py-5 md:py-8 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          <Part7PassageCard passage={passage} selectedAnswers={selectedAnswers} />
          <Part7PassageAnalysis
            passage={passage}
